...
export function createMobileThemeVariables(
  ...
  return {
    ...
    "--color-composer-surface": c.secondary,
    "--color-menu-surface": c.surfaceOverlay,
    ...
    "--color-primary-tonal": withAlpha(c.accent, appearance === "dark" ? 0.24 : 0.16),
    "--color-ring": c.accent,
    "--color-accent": withAlpha(c.accent, appearance === "dark" ? 0.18 : 0.1),
    "--color-accent-foreground": c.accent,
    "--color-accent-border": withAlpha(c.accent, appearance === "dark" ? 0.32 : 0.24),
    "--color-selection": withAlpha(c.accent, appearance === "dark" ? 0.22 : 0.16),
