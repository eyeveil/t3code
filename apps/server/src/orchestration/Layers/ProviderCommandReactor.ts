...
const make = Effect.gen(function* () {
  ...
  const ensureSessionForThread = Effect.fn("ensureSessionForThread")(function* (
    ...
    if (
      ...
      // Live sessions carry their cursor across a restart. A stopped session
      // can explicitly start fresh on the target account below.
      if (
        activeSession !== undefined &&
    ...
    const startProviderSession = (input?: {
      ...
      providerService
        .startSession(threadId, {
          ...
          ...(activeSession === undefined && currentInstanceId !== desiredInstanceId
            ? { freshSession: true }
            : {}),
