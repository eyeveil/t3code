...
function ChatViewContent(props: ChatViewProps) {
  ...
  const onSend = async (
    ...
    // The durable outbox currently carries image payloads. New arbitrary file
    // attachments keep the upstream direct-steer path until that shared schema
    // is widened across web and mobile.
