...
The manifest records the imported Backplane revision and hashes of the shipped
bundles. `leading-decimal-and-load-errors.patch` preserves the local lexer and
project-load fixes; `src/kicad/vendorParser.test.ts` exercises the shipped code.
